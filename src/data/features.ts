export const features = [
  ...
  },
  {
    title: "Cross Browser",
    description:
      "Deliver a consistent experience across all major web browsers. My solution is tested and optimized to work flawlessly on Chrome, Firefox, Safari, Edge, and more, so your users can access your application without issues.",
  },
  {
    title: "Clean Code",
    description:
